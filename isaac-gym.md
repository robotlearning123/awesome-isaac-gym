# Isaac Gym Resources (Legacy Archive) 🦖

[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Status: Legacy](https://img.shields.io/badge/Status-Legacy-orange.svg)](#)

> ⚠️ **Isaac Gym (Preview Release) is no longer actively maintained by NVIDIA.**
> The final release is **Preview 4**; NVIDIA officially directs all users to migrate to **Isaac Lab**.
>
> 👉 **For new projects, see the main [README.md](README.md)** — the umbrella resource covering
> Isaac Lab 3.0, Isaac Sim 6.0, Newton 1.0, GR00T N1.7, Cosmos 3.0, and the full NVIDIA Isaac Platform.
>
> This file preserves curated Isaac Gym resources for ongoing users of the legacy framework
> and for historical reference.

---

## About Isaac Gym (Legacy)

Isaac Gym is a lightweight, standalone GPU-accelerated physics simulation for reinforcement learning. While **deprecated**, it remains in use for legacy projects because of:

- ✅ **Lightweight setup** — No Omniverse installation required
- ✅ **Proven & stable** — Battle-tested in hundreds of research papers (2021-2024)
- ✅ **Simpler pipeline** — Direct GPU physics without rendering overhead
- ✅ **Lower hardware requirements** — Works on older GPUs (RTX 2070+)

**Migration path**: For active development, port to [Isaac Lab](https://developer.nvidia.com/isaac/lab). See the [main README](README.md) for migration guides.
